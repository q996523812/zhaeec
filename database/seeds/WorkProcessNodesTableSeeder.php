...
class WorkProcessNodesTableSeeder extends Seeder
{
    ...
    private function getProcessId($projecttype){
        $work_process = WorkProcess::where('projecttype',$projecttype)->where('status','1')->first();
    ...
    private function createZczl(){
        ...
        $nodes = [
            ...
            $this->create($work_process_id,'31','中止录入',1,$role_id_0,'','','33'),
            $this->create($work_process_id,'32','中止退回',2,$role_id_0,'','','33'),
            ...
            $this->create($work_process_id,'39','发布',6,$role_id_4,'','32','99'),

            $this->create($work_process_id,'41','终结录入',1,$role_id_0,'','','43'),
            $this->create($work_process_id,'42','终结退回',2,$role_id_0,'','','43'),
            ...
            $this->create($work_process_id,'59','发布',6,$role_id_4,'','42','99'),

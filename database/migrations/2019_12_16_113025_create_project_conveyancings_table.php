...
class CreateProjectConveyancingsTable extends Migration
{
    /**
     * 产权转让
     *
    ...
    public function up()
    {
        Schema::create('project_conveyancings', function (Blueprint $table) {
            $table->string('id');
            //基础信息
    ...
    {
        Schema::dropIfExists('project_conveyancings');
    }
}

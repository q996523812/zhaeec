@extends('admin.suspend.layouts.edit')
    ...
    <div class="box-body">
      <div class="fields-group">
        <div class="row">
          ...
          <input type="hidden" id="id" name="id" value="{{$project->project_id}}" class="id form-control">
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <div class="input-group">
                      ...
                      <input type="text" id="date_matter" name="date_matter" value="{{$suspend->date_matter}}" class="form-control date_matter" placeholder="输入 中止日期">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3">
                    <textarea id="content" name="content" class="form-control content" rows="5" placeholder="输入 其它需要披露的事项">{{$suspend->content}}</textarea>
                  </td>
                </tr>

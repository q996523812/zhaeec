...
<div class="form-group  ">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
      <input type="text" id="remark" name="remark" value="{{$sftz->remark}}" class="form-control remark" placeholder="输入 备注">
    </div>
  </div>
</div>
<div class="form-group  ">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
      <input type="text" id="email" name="email" value="{{$sftz->email}}" class="form-control email" placeholder="输入 中心联系邮箱">
    </div>
  </div>
</div>
<div class="form-group  ">
...
<script>
    $(function () {
        ...
        $("#distpicker1").distpicker({
          autoSelect: false,
          province: "{{$sftz->wtf_province}}",
          city: "{{$sftz->wtf_city}}",
          district: "{{$sftz->wtf_area}}"
        });
*/
        //日期
        ...
        //自动大写转换
        $('#zbjg_xx').convert({"outputid":"zbjg_dx"});
        $('#wtf_fwf_xx').convert({"outputid":"wtf_fwf_dx"});
        $('#zbf_fwf_xx').convert({"outputid":"zbf_fwf_dx"});

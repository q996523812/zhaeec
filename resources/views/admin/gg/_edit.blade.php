<form action="/admin/winnotices/add" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="" id="formdetail">    
    {{ csrf_field() }}
    <input type="hidden" id="project_id" name="project_id" value="{{$zzgg->project_id}}" class="project_id">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <div class="input-group">
        ...
        <input type="text" id="xmbh" name="xmbh" value="{{$zzgg->xmbh}}" class="form-control readonly xmbh" placeholder="输入 项目编号" readyonly="readonly">
      </div>
    </div>
  </div>
</div>
...
<div class="form-group  ">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
      <input type="text" id="wtf" name="wtf" value="{{$zzgg->wtf}}" class="form-control wtf" placeholder="输入 委托方" readyonly="readonly">
    </div>
  </div>
</div>
...
<div class="form-group  ">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
      <input type="text" id="content" name="content" value="{{$zzgg->content}}" class="form-control content" placeholder="输入 理由">
    </div>
  </div>
</div>

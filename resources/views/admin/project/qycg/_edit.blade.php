<form action="http://zhaeec.test/admin/projectpurchases/fdba11d3-8daa-4e7e-bd9d-69a66cf9cbe7" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="" id="formdetail">
<div class="box-body">

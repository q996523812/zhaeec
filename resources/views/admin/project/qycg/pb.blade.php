  ...
  <div class="box-header with-border">
    ...
    <div class="box-tools">
      <div class="btn-group float-right" style="margin-right: 10px">
        <a href="/admin/projectpurchases" class="btn btn-sm btn-default"><i class="fa fa-list"></i> 列表</a>
      </div>
    </div>
  </div>
  <div class="box-body">
...
<input style="width: 160px" type="text" id="gp_date_end" name="gp_date_end" value="{{$project->gp_date_end}}" class="form-control gp_date_end" placeholder="输入 挂牌结束日期">
</div>
...
<div class="col-md-12">
<input type="hidden" name="status" value="{{$project->status}}" class="status">
</div>
<div class="col-md-12">
<input type="hidden" name="process" value="{{$project->process}}" class="process">
</div>
<div class="col-md-12">
<input type="hidden" name="user_id" value="{{$project->user_id}}" class="user_id">
</div>
<div class="col-md-12">
<input type="hidden" name="project_id" value="{{$project->project_id}}" class="project_id">
</div>
<div class="col-md-12">
<input type="hidden" name="id" value="{{$project->id}}" class="id">
</div>
<div class="col-md-12">
...
<!--</form>      -->   
        ...
        <div class="tab-pane fade" id="tab5">
          ...
          <div>
        <form action="/admin/projectpurchases/pb/{{$project->project_id}}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
          {{csrf_field()}}
          ...
          <div class="btn-group pull-right">
              <button type="buttion" class="btn btn-primary btn-pass" style="margin-right:100px;">保存</button>
              <button type="submit" class="btn btn-primary btn-back">全部提交</button>
          </div>
        </form>
</div>
        </div>

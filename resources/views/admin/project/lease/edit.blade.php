...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="gpjg_zj" name="gpjg_zj" value="{{$detail->gpjg_zj}}" class="form-control gpjg_zj" placeholder="输入 总租金">
      </td>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="gpjg_dj" name="gpjg_dj" value="{{$detail->gpjg_dj}}" class="form-control gpjg_dj" placeholder="输入 总租金">
      </td>
      <td class=" control-label">租赁期限（月）</td>
      <td>
        <input type="text" id="zlqx" name="zlqx" value="{{$detail->zlqx}}" class="form-control zlqx" placeholder="输入 是否含税">
      </td>
    </tr>    
    <tr>
    ...
    <tr>
      ...
      <td colspan="3">
        <input type="text" id="pgjz" name="pgjz" value="{{$detail->pgjz}}" class="form-control pgjz" placeholder="输入 标的资产评估值(人民币)元">
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="jjfd" name="jjfd" value="{{$detail->jjfd}}" class="form-control jjfd" placeholder="输入 加价幅度">
      </td>
    </tr>
    <!--
    <tr>
  ...
  -->
    ...
    <tr>
      ...
      <td colspan="3">
        <input type="text" id="bzj" name="bzj" value="{{$detail->bzj}}" class="form-control bzj" placeholder="输入 竞标保证金金额">
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="fc_mj" name="fc_mj" value="{{$detail->fc_mj}}" class="form-control fc_mj" placeholder="输入 面积">
      </td>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="fc_ysynx" name="fc_ysynx" value="{{$detail->fc_ysynx}}" class="form-control fc_ysynx" placeholder="输入 已使用年限">
      </td>
    </tr>
    <tr>

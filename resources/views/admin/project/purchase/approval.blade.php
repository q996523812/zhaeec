...
<form action="http://zhaeec.test/admin/projects/{{$project->project_id}}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
<div class="box-body">
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td rowspan="2" class=" control-label"><lavle class=" control-label">交易内容</lavle></td>
      <td class=" control-label">项目编号</td>
      <td colspan="3"><input type="text" id="wtf_name" name="wtf_name" value="{{$project->wtf_name}}" class="form-control wtf_name" placeholder="输入 委托方名称"></td>
    </tr>
    <tr>
    ...
    <!--委托方-->
    <tr>
      <td rowspan="10" class=" control-label">委托方</td>
    ...
    <tr>
      <td class=" control-label">委托方地区</td>
      <td>
    ...
    <tr>
      <td class=" control-label">委托方地址</td>
      <td colspan="3">
  ...
  <div class="box-footer">
      ...
      <div class="col-md-8">
        <form action="/admin/projects/approval/{{$project->project_id}}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
          ...
          <input type="hidden" id="process" name="process" value="{{$project->process}}">

  	...
  	<tr>
		...
		<td colspan="2" class="unput">
			<input type="text" name="pgbajg" class="form-control" validtype="length[0,50]" size="50" required="required" value="{{$pgqk->pgbajg}}">
   			<input name="hezhunFlag" type="checkbox" value="1" @if($pgqk->hezhunFlag) checked @endif >核准 &nbsp;&nbsp;&nbsp;&nbsp;
    		<input name="beianFlag" type="checkbox" value="1" @if($pgqk->beianFlag) checked @endif>备案
    	</td>
  	</tr>
  	<tr>
		<td>核准（备案）日期</td>

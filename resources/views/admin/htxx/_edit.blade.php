  ...
  <div class="col-sm-8">
    <div class="input-group">
      <div class="input-group">
        ...
        <input type="text" id="xmbh" name="xmbh" value="{{$project->xmbh}}" class="form-control readonly xmbh" placeholder="输入 项目编号" disabled="disabled">
      </div>
    </div>
  </div>
</div>
...
<div class="form-group  ">
  ...
  <div class="col-sm-8">
    <div class="input-group">
      <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
      <input type="text" id="title" name="title" value="{{$project->title}}" class="form-control title" placeholder="输入 标的名称" disabled="disabled">
    </div>
  </div>
</div>
<div class="form-group  ">
